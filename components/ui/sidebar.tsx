...
// Modifique o SidebarProvider para incluir persistência no localStorage
export function SidebarProvider({ children }: { children: React.ReactNode }) {
  // Inicializar o estado a partir do localStorage ou usar o valor padrão
  ...
  // Opcional: Colapsar automaticamente em telas pequenas durante a navegação
  useEffect(() => {
  ...
  return (
    <main
      ...
      className={cn(
        ...
        state === "expanded" ? "md:ml-[16rem]" : "md:ml-0", // Removida a margem de 3rem quando colapsado
