        ...
        tooltipContent={
          <>
            <div className="flex justify-between items-center mt-1 mb-2">
              ...
              <p className="font-bold text-green-600 dark:text-green-400">{formatCurrencyWithUserSettings(receitas)}</p>
            </div>
            <p className="text-sm text-muted-foreground">
      ...
      <SummaryCard
        ...
        tooltipContent={
          <>
            ...
            <p className="text-sm text-muted-foreground">Soma de todas as saídas financeiras no período selecionado.</p>
            {despesas !== 0 && (
              <div className="mt-2 p-2 bg-red-100/50 dark:bg-red-900/20 rounded-md">
                <p className="text-xs text-red-700 dark:text-red-300">
                  As despesas representam {Math.round((Math.abs(despesas) / (receitas + Math.abs(despesas))) * 100)}% do
